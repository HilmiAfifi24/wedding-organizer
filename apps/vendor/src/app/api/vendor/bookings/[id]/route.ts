...
export async function GET(
  ...
  try {
    ...
    const { getVendorBookingDetailUseCase } = createVendorBookingManagementUseCases();
    const data = await getVendorBookingDetailUseCase.execute(vendorId, parsedParams.data.id);
