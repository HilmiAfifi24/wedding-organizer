...
export function LoginForm() {
  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    try {
      ...
      if (res?.error) {
        setError("Email atau password salah, atau Anda bukan seorang Vendor.");
      } else {
    ...
    <Card className="w-full max-w-md border border-white/20 bg-white/80 p-2 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:shadow-amber-500/10 dark:border-zinc-800/80 dark:bg-zinc-950/80">
      <CardHeader className="space-y-1 text-center">
        <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-950/50">
          ...
          >
            <path
              ...
              d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.36m11.14 0H18m0 0h3.64m-1.39 0V9.349m-16.5 11.65V9.35m0 0a3.001 3.001 0 003.75-.615A2.993 2.993 0 009.75 9.75c.896 0 1.7-.393 2.25-1.016a2.993 2.993 0 003.75.614m-16.5 0a3.004 3.004 0 01-.621-4.72L4.318 3.44A1.5 1.5 0 015.378 3h13.243a1.5 1.5 0 011.06.44l1.19 1.189a3 3 0 01-.621 4.72M6.75 18h3.5a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75h-3.5a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75z"
            />
          </svg>
        </div>
        ...
        <CardDescription className="text-zinc-500 dark:text-zinc-400">
          Masuk untuk mengelola layanan dan booking pernikahan
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 transition-all duration-300 focus:border-amber-500 focus:ring-amber-500/20 dark:bg-zinc-900"
              />
            </div>
            {errors.email && (
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="••••••"
                className="pl-10 pr-10 transition-all duration-300 focus:border-amber-500 focus:ring-amber-500/20 dark:bg-zinc-900"
              />
              <button
                type="button"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-amber-600 text-white hover:bg-amber-700 active:scale-[0.98] transition-transform duration-100 dark:bg-amber-700 dark:hover:bg-amber-600"
          >
            {loading ? (
